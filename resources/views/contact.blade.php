...
@section('content')
<!-- Hero Section -->
<section class="contact-hero-section" style="background: linear-gradient(135deg, #f5fbff 0%, #d8f0ff 100%); color: #1f3a5d; padding: 80px 20px; text-align: center;">
    <div class="container" style="max-width: 1000px; margin: 0 auto;">
        <h1 class="contact-hero-title" style="font-size: 48px; font-weight: 700; margin-bottom: 20px;">Get in Touch</h1>
        <p style="font-size: 18px; color: #1f3a5d; line-height: 1.6;">Let's Design Your Dream Space Together</p>
    </div>
</section>

<!-- Contact Section -->
<section class="contact-section" style="padding: 80px 20px; background: white;">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <div class="contact-main-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;">
            <!-- Contact Form -->
            <div>
                <h2 class="contact-form-title" style="font-size: 32px; font-weight: 700; margin-bottom: 30px; color: #2c3e50;">Book Your Free Consultation</h2>
            ...
            <!-- Contact Information -->
            <div>
                <h2 class="contact-info-title" style="font-size: 32px; font-weight: 700; margin-bottom: 30px; color: #2c3e50;">Let's Connect</h2>
...
<section class="contact-next-section" style="padding: 80px 20px; background: #f8f9fa;">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <h2 class="contact-next-heading" style="font-size: 36px; font-weight: 700; text-align: center; margin-bottom: 50px; color: #2c3e50;">What Happens Next?</h2>
...
<!-- Services Overview -->
<section class="contact-serve-section" style="padding: 80px 20px; background: white;">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <h2 class="contact-serve-heading" style="font-size: 36px; font-weight: 700; text-align: center; margin-bottom: 50px; color: #2c3e50;">We Serve</h2>
...
<!-- Final CTA Section -->
<section class="contact-cta-section" style="padding: 60px 20px; background: linear-gradient(135deg, #f5fbff 0%, #d8f0ff 100%); color: #1f3a5d; text-align: center;">
    <div class="container" style="max-width: 800px; margin: 0 auto;">
        <h2 class="contact-cta-title" style="font-size: 32px; font-weight: 700; margin-bottom: 20px;">Let's Create Something Beautiful</h2>
        <p class="contact-cta-desc" style="font-size: 16px; margin-bottom: 30px; opacity: 0.9;">Contact Velsuma today to start your interior transformation journey. Your dream space is just a consultation away.</p>
        <div class="contact-cta-buttons" style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
